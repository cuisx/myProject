...
(function(exports) {
  ...
  // Change email format judge, abc@abc is not a email address.
  // Changed by guirw@tcl.com for bug 3005613.
  //var rmail = /[\w-]+@[\w\-]/;
  //var rmail = /[\w.+-]+@[\w.-]+\.[a-z.]{2,6}/mgi;/*yan.ai-3403072,change the var to partial var.*/
  ...
  var Utils = {
    ...
    */
    ...
    isEmailAddress: function(email) {
      var rmail = /[\w.+-]+@[\w.-]+\.[a-z.]{2,6}/mgi;//yan.ai@tcl.com-3403072,if rmail is global, return value is wrong.
    ...
    */
    closeNotificationsForThread: function ut_closeNotificationsForThread(tid) {
      ...
      // Added by guirw@tcl.com for sms notification problem.
      var targetData= 'threadId:' + threadId;
